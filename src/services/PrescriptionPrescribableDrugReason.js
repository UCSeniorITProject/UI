...
export async function getPrescriptionPrescribableDrugReasonBreakdownForDoctor(doctorId) {
	const prescriptionPrescribableDrugReasonBreakdown = await Axios.get(`${process.env.REACT_APP_API_URL}/api/pharmacy-service/prescription-prescribable-drug-reason/doctor/${doctorId}/breakdown`);
