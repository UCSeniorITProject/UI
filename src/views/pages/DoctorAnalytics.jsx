...
import {
  getPrescribableBreakdown,
  getPrescribableBreakdownByPatientForDoctor,
  getNumPrescribablesPerMonthForDoctor,
...
class DoctorAnalytics extends React.Component {
  ...
  async componentDidMount() {
    try {
      const [
        prescriptionsByMonthForDoctor,
        prescribableBreakdown,
        reasonBreakdown,
        prescribableBreakdownForPatient,
        prescribablesByMonth,
      ] = await Promise.all([
        getPrescriptionByMonthForDoctor(this.state.doctorId),
        getPrescribableBreakdown(this.state.doctorId),
        getPrescriptionPrescribableDrugReasonBreakdownForDoctor(
          this.state.doctorId
        ),
      ...
      this.setState({
        prescriptionsByMonthData: this.getPrescriptionByMonthChart(
          prescriptionsByMonthForDoctor
        ),
        prescribableBreakdown: this.getPrescribableBreakdownChart(
          prescribableBreakdown
        ),
        reasonBreakdown: this.getReasonBreakdownChart(reasonBreakdown),
        patientBreakdown: this.getPatientBreakDownChart(
          prescribableBreakdownForPatient
        ),
        prescribablesByMonth: this.getPrescribablesByMonthChart(
          prescribablesByMonth
        ),
      });
    } catch (err) {
              ...
              <Card className="card-chart">
                <CardHeader>
                  <Row>
                    <Col className="text-left" sm="6">
                      <CardTitle tag="h2">
                        Patient Prescribable Breakdown
                      </CardTitle>
                    </Col>
                  </Row>
                </CardHeader>
