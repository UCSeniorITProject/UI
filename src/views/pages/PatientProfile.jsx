...
class PatientProfile extends React.Component {
  ...
  async componentDidMount() {
    ...
    const patient = await getPatientWithFilter({ patientId: patientId });
    ...
    await this.setState({
      ...
      truncatedSsn: `***-**-${
        patient[0].socialSecurityNumber !== null &&
        patient[0].socialSecurityNumber !== ""
          ? patient[0].socialSecurityNumber.substr(
              patient[0].socialSecurityNumber.length - 3,
              patient[0].socialSecurityNumber.length
            )
          : ""
      }`,
  ...
  async onSaveClick(e) {
    if (!this.isFormValid()) {
      ...
      options = {
        ...
        message: (
          <div>
            <div>Please correct the validation errors before saving!</div>
          </div>
        ),
        type: "warning",
      ...
      try {
        ...
        options = {
          ...
          message: (
            <div>
              <div>Succesfully saved the patient!</div>
            </div>
          ),
          type: "success",
          icon: "tim-icons icon-bell-55",
        ...
        options = {
          ...
          message: (
            <div>
              <div>An error occured while saving, please try again later.</div>
            </div>
          ),
          type: "warning",
          icon: "tim-icons icon-bell-55",
  ...
  isFormValid() {
    return (
      Object.entries(this.state).filter(
        (x) =>
          x[1] !== null && x[0].includes("State") && x[1].includes("has-danger")
      ).length === 0
    );
  }
  ...
  showInvalidDateMessage() {
    ...
    options = {
      ...
      message: (
        <div>
          <div>You entered an invalid date!</div>
        </div>
      ),
      type: "warning",
      icon: "tim-icons icon-bell-55",
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      <Col md="6">
                        ...
                        >
                          ...
                          <Input
                            ...
                            type="text"
                            onChange={(e) =>
                              this.change(e, "firstName", "length", "1")
                            }
                      ...
                      <Col md="6">
                        ...
                        >
                          ...
                          <Input
                            ...
                            type="text"
                            onChange={(e) =>
                              this.change(e, "lastName", "length", 1)
                            }
                      ...
                      <Col md="6">
                        <FormGroup
                          className={`has-label ${this.state.addressState}`}
                        >
                      ...
                      <Col md="6">
                        <FormGroup
                          className={`has-label ${this.state.stateState}`}
                        >
                          <label>State</label>
                          <Input
                            id="state"
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <Col md="6">
                        <FormGroup
                          className={`has-label ${this.state.phoneNumberState}`}
                        >
              ...
              <Form>
                <Card>
                  ...
                  <CardBody>
                    <Col md="12">
                      <FormGroup
                        className={`has-label ${this.state.insuranceNameState}`}
                      >
                    ...
                    <Col md="12">
                      <FormGroup
                        className={`has-label ${this.state.insurancePlanNoState}`}
                      >
                    ...
                    <Col md="12">
                      <FormGroup
                        className={`has-label ${this.state.insuranceCoPayAmountState}`}
                      >
                        ...
                        />
                        {this.state.insuranceCoPayAmountState ===
                        "has-danger" ? (
                          <label className="error">
                            This field is required.
                          </label>
