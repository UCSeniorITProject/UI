            ...
            <div className="actions-right">
              ...
              <Button
                className={className("btn-icon", "btn-link", "like", {
                  "btn-neutral":
                    this.state.selectedPharmacyId === Number(x.pharmacyId),
                })}
                size="sm"
                color={
                ...
                onClick={(e) => {
                  this.props.onChildStateChange("pharmacyId", x.pharmacyId);
                  this.setState({
                    currentlySelectedPharmacyName: `${x.name}`,
                    selectedPharmacyId: Number(x.patientId),
                  });
                }}
              >
        ...
        <Row>
          <Col md="9">
            <h5 className="info-text float-left">
              <b>
                Pharmacy Picker (Currently Selected Pharmacy:{" "}
                {this.state.currentlySelectedPharmacyName})
              </b>
            </h5>
          </Col>
          <Col md="3">
